...
<form:form id="display" action="send" method="post" modelAttribute="transaction">
    <label>Send Money To  Other person's Account</label> <br>
    ...
    <form:input placeholder ="1235" path="toAccountNumber" />
